                ...
                child: ReactiveForm(
                  ...
                  child: ListView(
                    ...
                    children: [
                              ...
                              builder: (context) => AddEditContact(
                                title:
                                    bringInfo('Contact_1').toString() == "Empty"
                                        ? 'Edit Contact'
                                        : 'Add Contact',
                                name: contactForm.control('name1')
                                    as FormControl, //read first , change later
                      ...
                      CustomCardTile(
                        icon: 'person',
                        title: bringInfo('Contact_2').toString() != "Empty"
                            ? bringInfo('Contact_2').toString()
                            : "contact#2 is not set",
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => AddEditContact(
                                ...
                                phoneNumber: contactForm.control(
                                        'phoneNumber2') //add the value ints of this
                                    as FormControl,
                              ),
                            ),
                          );
                      ...
                      CustomCardTile(
                        icon: 'person',
                        title: bringInfo('Contact_3').toString() != "Empty"
                            ? bringInfo('Contact_3').toString()
                            : "contact#3 is not set",
