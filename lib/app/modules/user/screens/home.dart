...
import 'package:untitled_design/app/modules/user/screens/send_circumstances.dart';
                    ...
                    ShadowedCard(
                      ...
                      child: buildCard(
                        () => Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const SendCircumstances(),
                          ),
                        ),
                        'helpme',
                        'Help me',
                    ...
                    ShadowedCard(
                      ...
                      child: buildCard(
                        () => Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const Categories(text: 'Help them'))),
                        'helpthem',
                        'Help them',
                      ),
                    ),
